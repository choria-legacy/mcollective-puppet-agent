    ...
    module Common
      ...
      describe "#runonce!" do
        ...
        it "should support returning foreground run arguments only" do
          ...
          Common.runonce!(:foreground_run => true, :options_only => true).should == [:foreground_run, ["--onetime","--no-daemonize","--color=false", "--show_diff","--verbose"]]
        end
        ...
        it "should support returning foreground run arguments only" do
          ...
          Common.runonce!(:options_only => true).should ==  [:run_in_foreground, ["--onetime","--no-daemonize","--color=false", "--show_diff","--verbose"]]
        end
      end
